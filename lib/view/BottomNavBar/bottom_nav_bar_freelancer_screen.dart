...
class BottomNavBarFreelancerScreen extends StatefulWidget {
  ...
  @override
  State<BottomNavBarFreelancerScreen> createState() => _BottomNavBarFreelancerScreenState();
}

class _BottomNavBarFreelancerScreenState extends State<BottomNavBarFreelancerScreen> {
          ...
          child: BottomNavigationBar(
            ...
            items: <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                ...
                label: 'Dashboard',
                activeIcon:
                    getSvgImage('fill_dashboard_icon.svg',),
              ),
              BottomNavigationBarItem(
                icon: getSvgImage(
                  'wallet_icon.svg',
                ...
                label: 'Wallet',
                activeIcon:
                    getSvgImage('fill_wallet_icon.svg',),
              ),
              BottomNavigationBarItem(
                icon: getSvgImage(
                  'settings_icon.svg',
                ...
                label: 'Setting',
                activeIcon:
                    getSvgImage('fill_settings_icon.svg'),
              ),
            ],
